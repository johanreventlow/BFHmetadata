...
- [ ] **Step 1: Write failing tests for bounded HTML and value preservation**
...
- [ ] **Step 3: Implement the bounded initial choices**
...
- [ ] **Step 1: Write failing server-initialization tests**
...
- [ ] **Step 3: Implement post-modal server initialization**
...
- [ ] **Step 4: Run diagram and indicator-modal regressions**
...
- [ ] **Step 1: Reproduce the original large-list scenario in a real browser**
